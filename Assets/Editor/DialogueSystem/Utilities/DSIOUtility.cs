...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        private static void LoadGroups(List<DSGroupSaveData> groups)
        {
            ...
            {
                DSGroup group = graphView.CreateGroup(groupData.Position, groupData.Name);
        ...
        private static void LoadNodes(List<DSNodeSaveData> nodes)
        {
            foreach (DSNodeSaveData nodeData in nodes)
            {
                ...
                DSNode node = graphView.CreateNode(nodeData.DialogueType, nodeData.Position, false, nodeData.Name);
